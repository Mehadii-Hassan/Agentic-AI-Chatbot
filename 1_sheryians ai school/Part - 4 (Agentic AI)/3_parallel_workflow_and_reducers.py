import os
from typing import TypedDict, Annotated  # annotated is a reducer
...
def marge_score_dicts(existing : dict, newupdate : dict) -> dict:
    if existing is None:
        return newupdate
...
class AnalyzerState(TypedDict):
    raw_text : str
    safety_score : Annotated[dict[str, int], marge_score_dicts]
